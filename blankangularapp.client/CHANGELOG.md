...
- Create Angular project with ng: `ng new blankangularapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`blankangularapp.client.esproj`).
